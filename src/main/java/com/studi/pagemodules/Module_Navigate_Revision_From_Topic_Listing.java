...
import com.studi.pageobjects.Object_Navigate_Revision_From_Topic_Listing;
import com.studi.pageobjects.Object_View_Chapters_Listing;


public class Module_Navigate_Revision_From_Topic_Listing {

	public static String getBookShelfPage, getAllChaptersPage, getFieldLabel, getFieldLabel1, getNameChapter1,
			getNameChapter2, getTopicNames1Chapter1, getTopicNames2Chapter1, getTopicNames3Chapter1,
			getTopicNames4Chapter1, getTopicName1Chapter2, getTopicName2Chapter2, getOnboardingPage;
	...
	public void Verify_Navigate_Revision_From_Topic_Listing() throws InterruptedException, AWTException {
		...
		Object_Navigate_Revision_From_Topic_Listing RMQP1 = new Object_Navigate_Revision_From_Topic_Listing();
		...
		RMQP1.selectTopic.click();
		RMQP1.select_Begin_Revision.click();
		getOnboardingPage = RMQP1.verify_OnboardingPage.getText();
		if (getOnboardingPage.contains("WHAT YOU WILL REVISE"))
			System.out.println("Onboarding page shown");
		else
			System.out.println("Onboarding page not shown");

		RMQP1.gobackFrom_OnboardingPage.click();
